...
<html lang="en">
  ...
  <body style="background-color:#202125;">
    <div class="container" style="padding-top:30px;">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Successfully deleted image file <b><?php echo basename($_GET["delete"]); ?></b>
            </div>
      ...
      <!-- Modal Delete Not OK-->
      <div class="modal fade" id="myModalNotOK" tabindex="-1" aria-labelledby="myModalNotOKLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header" style="background-color:#fc8403;">
              <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Error</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              Something went wrong while deleting file <?php echo basename($_GET["delete"]); ?>
            </div>
            <div class="modal-footer">
